            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-6 flex-1">
                        ...
                        <p class="text-blue-700 mb-6 text-lg">Copiez ce token maintenant car il ne sera plus jamais affiché
                            après cette session.</p>

                        <div class="bg-white rounded-xl border-2 border-blue-300 p-6 shadow-sm">
                            <div class="flex items-center gap-4">
                                <code id="session-token"
                                    class="flex-1 text-base font-mono text-gray-800 bg-gray-50 p-4 rounded-lg border select-all break-all">{{ session('token') }}</code>
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if ($tokens->count() > 0)
                        <div class="flex items-center gap-3">
                            <span
                                class="inline-flex items-center px-3 py-1 bg-green-100 rounded-full text-green-800 text-sm font-medium">
                                <div class="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                                {{ $tokens->where('is_active', true)->count() }} actifs
                            </span>
                            @if ($tokens->where('is_active', false)->count() > 0)
                                <span
                                    class="inline-flex items-center px-3 py-1 bg-gray-100 rounded-full text-gray-800 text-sm font-medium">
                ...
                <div class="p-8">
                    <div class="space-y-6">
                        @foreach ($tokens as $token)
                            <div
                                class="border border-gray-200 rounded-xl p-6 hover:border-blue-300 transition-all duration-200 hover:shadow-md">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-4">
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-4 mb-3">
                                                <div class="flex items-center gap-3">
                                                    <code id="token-{{ $token->id }}"
                                                        class="flex-1 text-sm font-mono text-gray-800">{{ $token->masked_token }}</code>

                                                    <button
                                                        onclick="toggleToken('{{ $token->id }}', '{{ $token->token }}', '{{ $token->masked_token }}')"
                                                        id="toggle-{{ $token->id }}"
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <p class="text-gray-600 mb-8 max-w-md mx-auto">
                        Créez votre premier token API pour commencer à utiliser l'API UZASHOP Email. C'est rapide et
                        sécurisé !
                    </p>
                    <button onclick="openCreateModal()"
                    ...
                    <div class="p-4 bg-blue-50 border border-blue-200 rounded-xl">
                        <div class="flex">
                            ...
                            <div class="text-sm">
                                ...
                                <p class="text-blue-700 mt-1">Ce token sera utilisé pour authentifier vos requêtes API.
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex flex-wrap gap-2">
                            ...
                            <button type="button" onclick="setExpiration(365)"
                                ...
                                an</button>
                            <button type="button" onclick="clearExpiration()"
    ...
    <script>
        ...
        function toggleToken(tokenId, fullToken, maskedToken) {
            ...
            if (tokenElement.textContent === maskedToken) {
                ...
                tokenElement.className =
                    'flex-1 text-sm font-mono text-green-800 break-all select-all bg-green-50 p-2 rounded';
                toggleBtn.innerHTML = `
        ...
        `;
                ...
                setTimeout(() => {
                    ...
                    btn.className =
                        'p-2 text-gray-500 hover:text-green-600 hover:bg-white rounded-lg transition-colors';
                }, 2000);
            }).catch(() => {
