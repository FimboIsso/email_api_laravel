...
<body
  ...
  "template_data": {
    "user_name": "{{ __('welcome.templates.example.user_name') }}",
    "platform_name": "{{ __('welcome.templates.example.platform_name') }}"
  }
}</pre>
                        </div>
                    </div>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    ...
                    <li>
                        <a href="https://github.com/FimboIsso/email_api_laravel" target="_blank"
                            class="inline-block px-5 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-sm text-sm leading-normal transition-colors">
