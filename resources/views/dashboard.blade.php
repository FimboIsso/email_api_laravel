...
<div class="space-y-6">
            ...
            <div>
                <h1 class="text-2xl font-bold">
                    @php
                        ...
                        elseif($hour < 17) echo 'Bon après-midi';
                        else echo 'Bonsoir';
                ...
                <p class="text-indigo-100 mt-2">
                    @php
                        ...
                        if($tokens == 0) echo "Créez votre premier token API pour commencer à utiliser notre service.";
                        else echo "Votre API est prête à l'emploi avec " . $tokens . " token(s) actif(s).";
                    @endphp
                </p>
            </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div class="flex">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <p class="text-xs text-blue-600">⚠️ Copiez ce token maintenant, il ne sera plus affiché pour des raisons de sécurité.</p>
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
            ...
            <div class="mt-4">
                <a href="{{ route('dashboard.tokens') }}" class="text-sm text-indigo-600 hover:text-indigo-500 font-medium">
                    Gérer les tokens →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
            ...
            <div class="mt-4">
                <a href="{{ route('dashboard.analytics') }}" class="text-sm text-green-600 hover:text-green-500 font-medium">
                    Voir les analytics →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
            ...
            <div class="mt-4">
                <a href="{{ route('dashboard.analytics') }}" class="text-sm text-blue-600 hover:text-blue-500 font-medium">
                    Voir détails →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
            ...
            <div class="mt-4">
                <a href="{{ route('dashboard.analytics') }}" class="text-sm text-orange-600 hover:text-orange-500 font-medium">
                    Historique →
                </a>
            </div>
        </div>
            ...
            <div class="p-6 space-y-4">
                <a href="{{ route('dashboard.tokens') }}" 
                   class="flex items-center p-4 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 hover:from-indigo-100 hover:to-purple-100 transition-all duration-200 group">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-semibold text-gray-900 group-hover:text-indigo-800">Créer un Token API</p>
                        <p class="text-xs text-gray-600">Générer un nouveau token pour vos applications</p>
                    </div>
                    <svg class="ml-auto w-4 h-4 text-gray-400 group-hover:text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dashboard.mail-config') }}" 
                   class="flex items-center p-4 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 transition-all duration-200 group">
                    ...
                    <svg class="ml-auto w-4 h-4 text-gray-400 group-hover:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </a>
                ...
                <a href="{{ route('dashboard.api-docs') }}" 
                   class="flex items-center p-4 rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 transition-all duration-200 group">
                    ...
                    <svg class="ml-auto w-4 h-4 text-gray-400 group-hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </a>
                ...
                <button onclick="showTestEmailModal()" 
                    ...
                    <svg class="ml-auto w-4 h-4 text-gray-400 group-hover:text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </button>
            </div>
        ...
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-900 flex items-center">
                <svg class="w-5 h-5 text-purple-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m-4 4l4 4-4 4"></path>
                </svg>
                Exemple d'Utilisation
            </h2>
        </div>
    ...
    "from_name": "Mon Application"
            ...
            <div class="mt-4 flex items-center justify-between">
                <p class="text-sm text-gray-600">
                    Remplacez <code class="bg-gray-100 px-2 py-1 rounded text-xs">VOTRE_TOKEN</code> par votre vrai token API.
                </p>
                <button onclick="copyToClipboard(`curl -X POST {{ url('/api/send-email') }} \\
  -H \"Authorization: Bearer VOTRE_TOKEN\" \\
  -H \"Content-Type: application/json\" \\
  -d '{
    \"to\": \"destinataire@example.com\",
